...
public abstract class Dao<ENTITY>{
	...
	protected LinkedList<ENTITY> doFindAll(StatementWrapper stw) throws SQLException {
	...
	protected ENTITY doGetOne(StatementWrapper stw) throws SQLException {
	...
	protected void doModification(StatementWrapper stw) throws SQLException {
		try {
			con=DbConnector.getInstancia().getConn();
			st=stw.makeStatement(con);
			st.executeUpdate();
	...
	protected void doAddWithGeneratedKeys(StatementWrapper stw, HasAutogeneratedKey ent) throws SQLException {
		try {
